        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav ml-auto">
                    ...
                    <a href="<?= base_url('member/logout'); ?>" class="nav-item nav-link"><i
                            class="fas fw fa-login"></i> Log out</a>
                    <?php } else { ?>
                    <a href="#" data-toggle="modal" data-target="#daftarModal" class="nav-item nav-link"><i
                            class="fas fw fa-login"></i> <span class="glyphicon glyphicon-user"></span>Daftar </a>
                    <a href="#" data-toggle="modal" data-target="#loginModal" class="nav-item nav-link"><i
                            class="fas fw fa-login"></i> Log in</a>
                    <?php } ?>
                    <span class="nav-item nav-link nav-right" style="display:block; margin-left: 10px;">Selamat
                        Datang
                        <b class="nav-item"><?= $user ?></b></span>
                </div>
            </div>
        </div>
    </nav>
