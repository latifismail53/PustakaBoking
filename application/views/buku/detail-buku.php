            ...
            <div class="col-sm-3 col-md-3">
                <div class="thumbnail" style="height: auto; position: relative; left: 100%; width: 200%">
                    <img src="<?php echo base_url(); ?>assets/img/upload/<?= $gambar; ?>"
                        style="max-width: 100%; max-height: 100%; height: 150px; width: 120px" alt="">
                    <div class="caption">
                        ...
                        <p>
                            <a href="<?= base_url('booking/tambahBooking/' . $id); ?>"
                                class="btn btn-outline-primary"><i class="fas fw fa-shopping-cart"></i> Booking</a>
                            <span class="btn btn-outline-secondary" onclick="window.history.go(-1)"><i
                                    class="fas fw fa-reply"></i> Kembali</span>
                        </p>
                    </div>
                </div>
            </div>
