...
class Pinjam extends CI_Controller
{
    ...
    public function bookingDetail()
    {
        ...
        $data['detail'] = $this->db->query("select id_buku,judul_buku,pengarang,penerbit,tahun_penerbit from booking_detail d, buku b where d.id_buku=b.id and d.id_booking='$id_booking'")->result_array();
    ...
    public function pinjamAct()
    {
        ...
        $no_pinjam = $this->ModelBooking->kodeotomatis('pinjam', 'no_pinjam'); //masih error !!
        $databooking = [
            'no_pinjam' => $no_pinjam,
